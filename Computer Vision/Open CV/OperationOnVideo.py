...
vid = cv.VideoCapture("A:\\My Files\\OTHERS\\shiv ratri.mp4")
...
#Various codec --
#DIVX, XVID, MJPG, X264, WMV1, WMV2 MP4V
fourcc = cv.VideoWriter_fourcc(*"XVID")  # *"XVID"
#It contain 4 parameter , name, codec,fps,resolution
output = cv.VideoWriter("PathVideo.avi", fourcc, 20.0, (640, 480), 0)   # 0 -> Gray and 1-> color
